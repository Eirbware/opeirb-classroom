...
export const onRequest = defineRouteMiddleware((context) => {
  ...
  if (sectionId === "courses") {
    ...
    if (
      currentFirstDepthSidebarEntry !== null &&
      currentFirstDepthSidebarEntry.type === "group"
    ) {
      // change the sidebar
      ...
      context.locals.starlightRoute.pagination = cropPagination(
        ...
        sectionId,
        lang === defaultLanguage ? undefined : lang,
        postId,
      );
    }
    ...
    context.locals.starlightRoute.pagination =
      !postId || !isNaN(Number(postId))
        ...
        : returnToIndex(sectionId, lang === defaultLanguage ? undefined : lang);
  }
